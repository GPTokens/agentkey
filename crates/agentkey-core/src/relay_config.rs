...
const LEGACY_EXTERNAL_PROVIDER: &str = concat!("Cod", "exPP");
const LEGACY_RELAY_PROVIDERS: &[&str] = &[LEGACY_EXTERNAL_PROVIDER, "AgentKeyLegacy", "AgentKeyPP"];
...
pub async fn test_relay_profile(
    ...
    let client = crate::http_client::proxied_client("AgentKey/RelayTest")?;
