...
async fn model_catalog_uses_active_relay_profile_model_list_for_display() {
    ...
    let previous_settings_path =
        agentkey_core::paths::set_settings_path_for_tests(Some(settings_path.clone()));
    unsafe {
    ...
    agentkey_core::paths::set_settings_path_for_tests(previous_settings_path);
