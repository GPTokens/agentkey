...
pub fn install_entrypoints() -> InstallActionResult {
    agentkey_core::install::install_entrypoints(&InstallOptions::default())
}

pub fn uninstall_entrypoints(options: InstallOptions) -> InstallActionResult {
    agentkey_core::install::uninstall_entrypoints(&options)
}

pub fn repair_shortcuts() -> InstallActionResult {
    agentkey_core::install::repair_entrypoints(&InstallOptions::default())
}
